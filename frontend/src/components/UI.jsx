...
export const Button = ({ variant = 'primary', className = '', disabled = false, ...props }) => {
  const variants = {
    primary: 'bg-green-600 hover:bg-green-700 text-white disabled:bg-gray-400 disabled:cursor-not-allowed',
    secondary: 'bg-blue-600 hover:bg-blue-700 text-white disabled:bg-gray-400 disabled:cursor-not-allowed',
    danger: 'bg-red-600 hover:bg-red-700 text-white disabled:bg-gray-400 disabled:cursor-not-allowed',
    outline: 'border-2 border-gray-300 hover:border-gray-400 disabled:border-gray-200 disabled:cursor-not-allowed',
  };
